...
###
    For solving This Problems i used python and its libraries Pandas,numpy,matplotlib
####
...
the​ ​columns​ ​from​ ​the​ ​data.
    ...
    Approach:
             ...
             step 7: i got two dataframes first one is BIHAR second one is TAMIL NADU, i need to plot the graph of those
             ...
             step 8: from above dataframes i plotted graph with similarity between the two states of districts.
